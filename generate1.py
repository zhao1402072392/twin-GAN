...
# python3 generate1.py data-bin/UN/million6way/en-fr/bpe/preprocessed/ --path data-bin/UN/million6way/en-fr/checkpoints/lr34clip1/best_gmodel.pt --beam 5 --batch-size 200 --remove-bpe | tee ./tmp/gen.out
