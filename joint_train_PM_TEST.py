...
def main(args):
    ...
    g_model_path = 'checkpoints/joint_warm/g_PGMLE.pt'
    ...
    d_model_path = 'checkpoints/joint_warm/d_orig.pt'
    ...
    if not os.path.exists('checkpoints/professorwarmGDori'):
        os.makedirs('checkpoints/professorwarmGDori')
    checkpoints_path = 'checkpoints/professorwarmGDori/'
    ...
    for epoch_i in range(1, args.epochs + 1):
        ...
        for i, sample in enumerate(trainloader):
            ...
            if random.random()>0.5 and i!=0:
                ...
                g_optimizer.zero_grad()
                if g_logging_meters["PG_train_loss"].avg < 0.5:
                    pg_loss_PG.backward()
                    torch.nn.utils.clip_grad_norm_(generator.parameters(), args.clip_norm)
                    g_optimizer.step()
            ...
            if g_logging_meters["MLE_train_loss"].avg < 3.0:
