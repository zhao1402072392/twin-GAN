...
from generator_sampleM_freePG import LSTMModel
...
def main(args):
    ...
    if not os.path.exists('checkpoints/sampleM_freePG'):
        os.makedirs('checkpoints/sampleM_freePG')
    checkpoints_path = 'checkpoints/sampleM_freePG/'
    ...
    for epoch_i in range(1, args.epochs + 1):
        ...
        for i, sample in enumerate(trainloader):
            ...
            if random.random() >= 0.5:
                ...
                sys_out_batch = generator('PG', epoch_i, sample)  # 64 X 50 X 6632
                ...
                sys_out_batch = generator("MLE", epoch_i, sample)
            ...
            with torch.no_grad():
                sys_out_batch = generator('MLE', epoch_i, sample)  # 64 X 50 X 6632
        ...
        for i, sample in enumerate(valloader):
            ...
            with torch.no_grad():
                ...
                sys_out_batch = generator('test', epoch_i, sample)
                out_batch = sys_out_batch.contiguous().view(-1, sys_out_batch.size(-1))  # (64 X 50) X 6632
