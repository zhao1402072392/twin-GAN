...
def main(args):
    ...
    if not os.path.exists('checkpoints/joint_warm_PG_MLE'):
        os.makedirs('checkpoints/joint_warm_PG_MLE')
    checkpoints_path = 'checkpoints/joint_warm_PG_MLE/'
    ...
    for epoch_i in range(1, args.epochs + 1):
        ...
        for i, sample in enumerate(trainloader):
            ...
            # logging.debug(f"D training loss {d_logging_meters['train_loss'].avg:.3f}, acc {d_logging_meters[
            #     'train_acc'].avg:.3f} at batch {i}")
        ...
        torch.save(generator,
                   open(checkpoints_path + f"joint1111111_{g_logging_meters['valid_loss'].avg:.3f}.epoch_{epoch_i}.pt",
