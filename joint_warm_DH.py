...
def main(args):
    ...
    if not os.path.exists('checkpoints/professor2WARMDH'):
        os.makedirs('checkpoints/professor2WARMDH')
    checkpoints_path = 'checkpoints/professor2WARMDH/'
    ...
    for epoch_i in range(1, args.epochs + 1):
        ...
        for i, sample in enumerate(trainloader):
            ...
            if num_update % 5 == 0:
                ...
                d_logging_meters['train_loss'].update(h_d_loss)
                logging.debug(f"D_h training loss {d_logging_meters['train_loss'].avg:.3f} at batch {i}")
        ...
        torch.save(discriminator_h,
                   open(checkpoints_path + f"DH_{d_logging_meters['train_loss'].avg:.3f}.epoch_{epoch_i}.pt",
                        'wb'), pickle_module=dill)
