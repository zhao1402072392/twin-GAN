...
def add_dataset_args(parser):
    ...
    parser.add_argument('--max-tokens', default=60, type=int, metavar='N',
...
def add_optimization_args(parser):
    ...
    parser.add_argument('--clip-norm', default=1.0, type=float,
                       help='clip threshold of gradients')  # 5.0
...
def add_checkpoint_args(parser):
    ...
    parser.add_argument("--save-dir", type=str, help="Location to dump the models.")
    return parser
...
def add_discriminator_model_args(parser):
    ...
    parser.add_argument('--discriminator-hidden-size', default=1024, type=int,
                        help='discriminator_hidden_size')
    parser.add_argument('--discriminator-linear-size', default=512, type=int,
                        help='discriminator_linear_size')
    parser.add_argument('--discriminator-lin-dropout', default=0.2, type=int,
                        help='discriminator_lin_dropout')
    return parser
...
def add_generation_args(parser):
    ...
    parser.add_argument('--unkpen', default=5, type=float,
                        help='unknown word penalty: <0 produces more unks, >0 produces fewer')
    parser.add_argument('--replace-unk', nargs='?', const=True, default=None,
                        help='perform unknown replacement (optionally with alignment dictionary)')
    parser.add_argument("--model-dir", type=str, help="Location to dump the models.")
    return parser
