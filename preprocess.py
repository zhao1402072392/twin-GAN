...
# python3 preprocess.py --source-lang en --target-lang de --trainpref data-bin/iwslt14.tokenized.de-en/WMT/train --validpref data-bin/iwslt14.tokenized.de-en/WMT/valid --testpref data-bin/iwslt14.tokenized.de-en/WMT/test --destdir data-bin/iwslt14.tokenized.de-en/WMT/preprocessed --joined-dictionary --workers 32
