...
def main(args):
    ...
    # Load generator
    assert os.path.exists('checkpoints/generator/numupdate2.998810066080318.data.nll_245000.0.pt')
    generator = LSTMModel(args, dataset.src_dict, dataset.dst_dict, use_cuda=use_cuda)
    model_dict = generator.state_dict()
    pretrained_dict = torch.load('checkpoints/generator/numupdate2.998810066080318.data.nll_245000.0.pt')
